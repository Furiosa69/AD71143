...
HD_PWD='D:/AD71143/AD71143-master/board/Project/project_1/project_1.runs/ila_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_0_1.tcl
