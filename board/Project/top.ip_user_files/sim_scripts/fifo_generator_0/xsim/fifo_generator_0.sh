...
#
# Script generated by Vivado on Mon Jul 06 14:13:46 CST 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_generator_0 xil_defaultlib.fifo_generator_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/furiosa/tool/software/vivado_2023.2_image/Vivado/2023.2/data/xsim"
  fi
