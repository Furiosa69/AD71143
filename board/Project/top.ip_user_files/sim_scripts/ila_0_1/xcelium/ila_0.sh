...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../top.gen/sources_1/ip/ila_0_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../top.gen/sources_1/ip/ila_0_1/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/furiosa/Projects/shitatechnology/work/ctrl/board/Project/top.cache/compile_simlib/xcelium"
  fi
