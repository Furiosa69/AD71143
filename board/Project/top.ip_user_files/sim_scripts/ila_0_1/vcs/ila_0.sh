...
#
# Script generated by Vivado on Wed Jul 08 18:10:23 CST 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../top.gen/sources_1/ip/ila_0_1/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../top.gen/sources_1/ip/ila_0_1/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/furiosa/Projects/shitatechnology/work/ctrl/board/Project/top.cache/compile_simlib/vcs"
  fi
