...
#
# Script generated by Vivado on Fri Jun 26 10:59:34 CST 2026
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/furiosa/Projects/shitatechnology/todo/Project/top.cache/compile_simlib/xcelium"
  fi
