...
namespace eval ::optrace {
  variable script "E:/ShiTa_Rob/AD71143/board/Project/top.runs/impl_1/top.tcl"
...
OPTRACE "Write Bitstream: post hook" START { }
  set src_rc [catch { 
    puts "source E:/ShiTa_Rob/AD71143/board/TCL/write_cfgmem.tcl"
    source E:/ShiTa_Rob/AD71143/board/TCL/write_cfgmem.tcl
  } _RESULT] 
  if {$src_rc} { 
    set tool_flow [get_property -quiet TOOL_FLOW [current_project -quiet]]
    if { $tool_flow eq {SDx} } { 
      send_gid_msg -id 2 -ssname VPL_TCL -severity ERROR $_RESULT
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script E:/ShiTa_Rob/AD71143/board/TCL/write_cfgmem.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script E:/ShiTa_Rob/AD71143/board/TCL/write_cfgmem.tcl failed"
    }
    return -code error
  }
