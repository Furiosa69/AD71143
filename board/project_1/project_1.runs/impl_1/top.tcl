...
namespace eval ::optrace {
  variable script "D:/project/AD71143/board/project_1/project_1.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/project/AD71143/board/project_1/project_1.runs/synth_1/top.dcp
...
OPTRACE "Write Bitstream: post hook" START { }
  set src_rc [catch { 
    puts "source D:/project/AD71143/board/project_1/project_1.srcs/utils_1/imports/TCL/write_cfgmem.tcl"
    source D:/project/AD71143/board/project_1/project_1.srcs/utils_1/imports/TCL/write_cfgmem.tcl
  } _RESULT] 
  if {$src_rc} { 
    set tool_flow [get_property -quiet TOOL_FLOW [current_project -quiet]]
    if { $tool_flow eq {SDx} } { 
      send_gid_msg -id 2 -ssname VPL_TCL -severity ERROR $_RESULT
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script D:/project/AD71143/board/project_1/project_1.srcs/utils_1/imports/TCL/write_cfgmem.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script D:/project/AD71143/board/project_1/project_1.srcs/utils_1/imports/TCL/write_cfgmem.tcl failed"
    }
    return -code error
  }
