...
#
# Script generated by Vivado on Sat Jul 25 10:30:46 +0800 2026
...
#
# Usage        : ila_0_1.sh
#                ila_0_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_0_1.sh [-reset_run]
#                ila_0_1.sh [-reset_log]
#                ila_0_1.sh [-help]
#
...
#                script (type 'ila_0_1.sh -help' for more information).
#
...
# script info
echo -e "ila_0_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_0_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../project_1.gen/sources_1/ip/ila_0_1/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../project_1.gen/sources_1/ip/ila_0_1/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_0_1 xil_defaultlib.glbl -o ila_0_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_0_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_0_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_0_1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_0_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_0_1.sh [-help]\n\
Usage: ila_0_1.sh [-step]\n\
Usage: ila_0_1.sh [-lib_map_path]\n\
Usage: ila_0_1.sh [-reset_run]\n\
Usage: ila_0_1.sh [-reset_log]\n\
Usage: ila_0_1.sh [-keep_index]\n\
Usage: ila_0_1.sh [-noclean_files]\n\n\
