...
module mdio_ctrl (
    ...
    // 常量
    // =====================================================================
    localparam PHY_ADDR    = 5'd4;      // 匹配硬件 strapping: RXD3=GND,RXCLK=GND,RXCTL=3.3V → PHY_ADDR=4
    ...
    // RGMII_Config1: GE_TX_delay[3:0] + FE_TX_delay[7:4] + RX_delay[13:10]
    //   0x0000: 所有延迟=最小值(≈50ps). 注意硬件strapping TXDLY=1/RXDLY=1,
    //           POR时set default非零值, 写0x0000强制override为最小延迟.
    //           FPGA clk_125m_ph90(135°)提供TXC相移, PHY内部不需要再叠加延迟.
